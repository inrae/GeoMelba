...
<qgis simplifyDrawingTol="1" maxScale="0" simplifyAlgorithm="0" version="3.16.14-Hannover" minScale="100000000" labelsEnabled="1" simplifyDrawingHints="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" styleCategories="AllStyleCategories" simplifyMaxScale="1" readOnly="0">
  <flags>
  ...
  <renderer-v2 type="RuleRenderer" symbollevels="0" forceraster="0" enableorderby="0">
    <rules key="{0d6d9acd-aaa1-4b6b-b911-480402226b4f}">
      <rule key="{0dd946c1-e908-4c84-ba32-4ceb25c80394}" symbol="0" label="vigne" filter=" &quot;type_sol&quot; // 100 = 1"/>
      <rule key="{b80f5fe3-511b-4f6b-af6d-b87a6b735e60}" symbol="1" label="verger" filter="&quot;type_sol&quot; // 100 = 2"/>
      <rule key="{24404c1f-5c82-4ef2-9f86-4185e227a512}" symbol="2" label="prairie" filter="&quot;type_sol&quot; // 100 =  3"/>
      <rule key="{8895efc2-2772-4588-875a-ee6b27c1858d}" symbol="3" label="bois" filter="&quot;type_sol&quot;  // 100 =  5"/>
      <rule key="{9a9d47ea-d0be-4d4c-ae44-e8dbc99cec6d}" symbol="4" label="friche" filter="&quot;type_sol&quot; // 100 =  4"/>
      <rule key="{6cb843fd-9f80-4cf9-8345-63bb9ec2cff6}" symbol="5" label="habitation" filter="&quot;type_sol&quot; // 100 =  7"/>
      <rule key="{88d08101-3e0c-42e3-b702-364f9f1d2bd3}" symbol="6" label="présence de rases" filter="&quot;type_sol&quot; % 100 >= 10 "/>
      <rule key="{45850cd7-d4f9-4263-bd3b-043c61ba388e}" symbol="7" label="enherbement" filter=" ( &quot;type_sol&quot; % 100)%10 = 1 "/>
    </rules>
    <symbols>
      ...
      <symbol alpha="1" type="fill" force_rhr="0" clip_to_extent="1" name="6">
        <layer enabled="1" class="LinePatternFill" pass="0" locked="0">
          ...
          <symbol alpha="1" type="line" force_rhr="0" clip_to_extent="1" name="@6@0">
            <layer enabled="1" class="SimpleLine" pass="0" locked="0">
              ...
              <prop k="joinstyle" v="bevel"/>
              <prop k="line_color" v="121,21,151,255"/>
        ...
        <layer enabled="1" class="SimpleLine" pass="0" locked="0">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="21,99,151,255"/>
      ...
      <symbol alpha="1" type="fill" force_rhr="0" clip_to_extent="1" name="7">
        <layer enabled="1" class="PointPatternFill" pass="0" locked="0">
          ...
          <symbol alpha="1" type="marker" force_rhr="0" clip_to_extent="1" name="@7@0">
            <layer enabled="1" class="SimpleMarker" pass="0" locked="0">
              <prop k="angle" v="0"/>
              <prop k="color" v="67,237,11,255"/>
              ...
              <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
              <prop k="offset_unit" v="MM"/>
              <prop k="outline_color" v="21,234,10,255"/>
              <prop k="outline_style" v="solid"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style fontLetterSpacing="0" fontWeight="50" fieldName="gm_id" isExpression="0" textOrientation="horizontal" multilineHeight="1" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontFamily="Ubuntu" fontSize="10" blendMode="0" textOpacity="1" previewBkgrdColor="255,255,255,255" fontItalic="0" textColor="0,0,0,255" fontStrikeout="0" fontWordSpacing="0" allowHtml="0" fontUnderline="0" namedStyle="Regular" fontSizeUnit="Point" fontKerning="1" capitalization="0" useSubstitutions="0">
        <text-buffer bufferSizeUnits="MM" bufferColor="255,255,255,255" bufferDraw="0" bufferNoFill="1" bufferBlendMode="0" bufferSize="1" bufferOpacity="1" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferJoinStyle="128"/>
        <text-mask maskJoinStyle="128" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskedSymbolLayers="" maskType="0" maskEnabled="0" maskSize="0" maskSizeUnits="MM" maskOpacity="1"/>
        <background shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeDraw="0" shapeSizeX="0" shapeOffsetUnit="MM" shapeBorderWidthUnit="MM" shapeBlendMode="0" shapeRadiiX="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeSVGFile="" shapeRotation="0" shapeBorderWidth="0" shapeJoinStyle="64" shapeSizeY="0" shapeOpacity="1" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeFillColor="255,255,255,255" shapeRadiiY="0" shapeOffsetX="0" shapeType="0" shapeSizeType="0" shapeBorderColor="128,128,128,255" shapeRadiiUnit="MM" shapeOffsetY="0" shapeSizeUnit="MM" shapeRotationType="0">
        ...
        <shadow shadowOffsetGlobal="1" shadowOffsetMapUnitScale="3x:0,0,0,0,0,0" shadowOffsetDist="1" shadowColor="0,0,0,255" shadowOffsetUnit="MM" shadowRadiusMapUnitScale="3x:0,0,0,0,0,0" shadowBlendMode="6" shadowDraw="0" shadowRadiusUnit="MM" shadowScale="100" shadowOffsetAngle="135" shadowUnder="0" shadowRadiusAlphaOnly="0" shadowRadius="1.5" shadowOpacity="0.7"/>
        <dd_properties>
          <Option type="Map">
            <Option type="QString" name="name" value=""/>
            <Option name="properties"/>
      ...
      <text-format decimals="3" formatNumbers="0" placeDirectionSymbol="0" leftDirectionSymbol="&lt;" plussign="0" multilineAlign="0" addDirectionSymbol="0" wrapChar="" rightDirectionSymbol=">" useMaxLineLengthForAutoWrap="1" reverseDirectionSymbol="0" autoWrapLength="0"/>
      <placement centroidWhole="0" maxCurvedCharAngleOut="-25" lineAnchorPercent="0.5" repeatDistance="0" quadOffset="4" xOffset="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" polygonPlacementFlags="2" geometryGeneratorEnabled="0" fitInPolygonOnly="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" yOffset="0" geometryGeneratorType="PointGeometry" layerType="PolygonGeometry" preserveRotation="1" overrunDistanceUnit="MM" lineAnchorType="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" priority="5" dist="0" placementFlags="10" offsetUnits="MM" rotationAngle="0" distUnits="MM" centroidInside="0" maxCurvedCharAngleIn="25" repeatDistanceUnits="MM" overrunDistance="0" offsetType="0" distMapUnitScale="3x:0,0,0,0,0,0" placement="0" geometryGenerator=""/>
      <rendering scaleMin="0" mergeLines="0" obstacleType="0" fontMaxPixelSize="10000" limitNumLabels="0" fontLimitPixelSize="0" labelPerPart="0" upsidedownLabels="0" obstacleFactor="1" minFeatureSize="0" maxNumLabels="2000" scaleMax="0" drawLabels="1" obstacle="1" scaleVisibility="0" zIndex="0" fontMinPixelSize="3" displayAll="0"/>
      <dd_properties>
        <Option type="Map">
          <Option type="QString" name="name" value=""/>
          <Option name="properties"/>
  ...
  <aliases>
    ...
    <alias index="2" field="gm_area" name=""/>
    <alias index="3" field="gm_length" name=""/>
    <alias index="4" field="gm_alti" name=""/>
    <alias index="5" field="gm_prop" name=""/>
    <alias index="6" field="gm_agri" name=""/>
    <alias index="7" field="gm_type" name=""/>
    <alias index="8" field="pente" name=""/>
    <alias index="9" field="gm_alti_up" name=""/>
    <alias index="10" field="gm_alti_dw" name=""/>
    <alias index="11" field="gm_ordre" name=""/>
    <alias index="12" field="gm_ordre_p" name=""/>
    <alias index="13" field="gm_uh_up" name=""/>
    <alias index="14" field="gm_uh_dwn" name=""/>
    <alias index="15" field="type_mid" name=""/>
  </aliases>
  <defaults>
  ...
  <constraints>
    ...
    <constraint field="gm_area" notnull_strength="0" exp_strength="0" constraints="0" unique_strength="0"/>
    <constraint field="gm_length" notnull_strength="0" exp_strength="0" constraints="0" unique_strength="0"/>
    <constraint field="gm_alti" notnull_strength="0" exp_strength="0" constraints="0" unique_strength="0"/>
    <constraint field="gm_prop" notnull_strength="0" exp_strength="0" constraints="0" unique_strength="0"/>
    <constraint field="gm_agri" notnull_strength="0" exp_strength="0" constraints="0" unique_strength="0"/>
    <constraint field="gm_type" notnull_strength="0" exp_strength="0" constraints="0" unique_strength="0"/>
    <constraint field="pente" notnull_strength="0" exp_strength="0" constraints="0" unique_strength="0"/>
    <constraint field="gm_alti_up" notnull_strength="0" exp_strength="0" constraints="0" unique_strength="0"/>
    <constraint field="gm_alti_dw" notnull_strength="0" exp_strength="0" constraints="0" unique_strength="0"/>
    <constraint field="gm_ordre" notnull_strength="0" exp_strength="0" constraints="0" unique_strength="0"/>
    <constraint field="gm_ordre_p" notnull_strength="0" exp_strength="0" constraints="0" unique_strength="0"/>
    <constraint field="gm_uh_up" notnull_strength="0" exp_strength="0" constraints="0" unique_strength="0"/>
    <constraint field="gm_uh_dwn" notnull_strength="0" exp_strength="0" constraints="0" unique_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint field="gm_area" desc="" exp=""/>
    <constraint field="gm_length" desc="" exp=""/>
    <constraint field="gm_alti" desc="" exp=""/>
    <constraint field="gm_prop" desc="" exp=""/>
    <constraint field="gm_agri" desc="" exp=""/>
    <constraint field="gm_type" desc="" exp=""/>
    <constraint field="pente" desc="" exp=""/>
    <constraint field="gm_alti_up" desc="" exp=""/>
    <constraint field="gm_alti_dw" desc="" exp=""/>
    <constraint field="gm_ordre" desc="" exp=""/>
    <constraint field="gm_ordre_p" desc="" exp=""/>
    <constraint field="gm_uh_up" desc="" exp=""/>
    <constraint field="gm_uh_dwn" desc="" exp=""/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="&quot;gm_id&quot;" sortOrder="0">
    <columns>
      ...
      <column type="field" width="-1" name="gm_area" hidden="0"/>
      <column type="actions" width="-1" hidden="1"/>
      <column type="field" width="-1" name="gm_type" hidden="0"/>
      <column type="field" width="-1" name="gm_alti" hidden="0"/>
      <column type="field" width="-1" name="gm_agri" hidden="0"/>
      <column type="field" width="-1" name="pente" hidden="0"/>
      <column type="field" width="-1" name="gm_length" hidden="0"/>
      <column type="field" width="-1" name="gm_prop" hidden="0"/>
      <column type="field" width="-1" name="gm_alti_up" hidden="0"/>
      <column type="field" width="-1" name="gm_alti_dw" hidden="0"/>
      <column type="field" width="-1" name="gm_ordre" hidden="0"/>
      <column type="field" width="-1" name="gm_ordre_p" hidden="0"/>
      <column type="field" width="-1" name="fid" hidden="0"/>
      <column type="field" width="-1" name="gm_uh_up" hidden="0"/>
      <column type="field" width="-1" name="gm_uh_dwn" hidden="0"/>
